...
$service->set('hoge', '本日は晴天なり', 'http://www.google.com/search?q=晴天');
$service->set('hoge', '本日は雨です', 'http://www.google.com/search?q=雨');
$service->set('hoge', '本日は快晴かも', 'http://www.google.com/search?q=快晴');
$service->set('hoge', '昨日は曇りでした', 'http://www.google.com/search?q=曇');
