...
class Temperance_FullText_Request_Set extends PhpBuf_Message_Abstract {
    public function __construct(){
        ...
        $this->setField('parser', PhpBuf_Type::ENUM, PhpBuf_Rule::OPTIONAL, 4, Temperance_FullText_Request_Parser::values());
    }
    public static function name(){
        return __CLASS__;
    }
...
class Temperance_FullText_Request_Get extends PhpBuf_Message_Abstract {
    public function __construct(){
        $this->setField('namespace', PhpBuf_Type::STRING, PhpBuf_Rule::REQUIRED, 1);
        $this->setField('str', PhpBuf_Type::STRING, PhpBuf_Rule::REQUIRED, 2);
...
class Temperance_FullText_Response_Get extends PhpBuf_Message_Abstract {
    public function __construct(){
...
class Temperance_FullTextService extends PhpBuf_RPC_Socket_Service_Client {
    public function __construct($host, $port){
        ...
        $this->registerMethodResponderClass('search', Temperance_FullText_Response_Get::name());
    }
}
